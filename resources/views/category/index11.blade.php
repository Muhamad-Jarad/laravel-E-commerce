                    ...
                    <div class="modal-body">
                        <div class="py-1">
                            <form action="{{route('categories.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <input id="" type="text" class="form-control" name="category_name"  required  placeholder="Category name" autofocus>
                                </div>
                    ...
                    <div class="modal-body">
                        <div class="py-1">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    <input id="" type="text" class="form-control" name="category_name" value=""  required  placeholder="Category name" autofocus>
                                </div>
